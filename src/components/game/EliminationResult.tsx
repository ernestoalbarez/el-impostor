...
export const EliminationResult = ({
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-[60vh] flex flex-col items-center justify-center px-4 relative z-10"
    >
      <BackgroundEffects />
      <div className="relative z-10 flex flex-col items-center">
        <motion.div
          ...
          className={cn(
            ...
            isImpostor ? 'bg-impostor/15 ring-2 ring-impostor/30' : 'bg-civil/15 ring-2 ring-civil/30'
          )}
        >
          {isImpostor ? (
        ...
        {gameOver && (
          <motion.div
            ...
            className={cn(
              'p-8 rounded-3xl mb-8 text-center card-glass',
